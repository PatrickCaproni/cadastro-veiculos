package com.PatrickCaproni.cadastroveiculo.resources;
...
import com.PatrickCaproni.cadastroveiculo.services.VeiculosService;
...
public class VeiculosResource {
	...
	@PostMapping
	public ResponseEntity<VeiculosDTO> insert(@RequestBody VeiculosDTO dto){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<VeiculosDTO> update(@PathVariable Long id, @RequestBody VeiculosDTO dto){
